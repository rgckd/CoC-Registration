const translations = {
  English: {
    ...
    languageHelper: "Your CoC groups will be conducted in this language.",
  ...
  Tamil: {
    ...
    languageLabel: "மொழி",
    languageHelper: "உங்கள் CoC குழுக்கள் இந்த மொழியில் நடத்தப்படும்.",
  ...
  Hindi: {
    ...
    languageLabel: "भाषा",
    languageHelper: "आपके CoC समूह इसी भाषा में संचालित किए जाएंगे।",
  ...
  Kannada: {
    ...
    languageHelper: "ನಿಮ್ಮ CoC ಗುಂಪುಗಳು ಈ ಭಾಷೆಯಲ್ಲಿ ನಡೆಸಲ್ಪಡುತ್ತವೆ.",
    languageLabel: "ಭಾಷೆ",
  ...
  Telugu: {
    ...
    languageHelper: "మీ CoC గ్రూపులు ఈ భాషలో నిర్వహించబడతాయి.",
    languageLabel: "భాష",
